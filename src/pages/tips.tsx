  ...
  const tips = [
    {
      ...
      title: '제주 버스 정보 시스템',
      content:
        '제주도에는 실시간 버스 정보 시스템이 별도로 존재합니다. 뚜벅이라면 꼭 참고하세요!',
    ...
    },
    {
      ...
      title: '짐 옮기기 서비스',
      content:
        '공항에서 숙소, 숙소에서 숙소, 숙소에서 공항까지 짐을 옮겨주는 서비스가 잘 되어있습니다. 뚜벅이는 적극 이용해보세요.',
      category: '교통',
    },
    {
      id: 3,
      ...
      title: '올레길 추천',
      content:
        '제주도에서 제대로 걸어보고 싶다면 올레길을 적극 이용해보세요. 숨은 명소들을 발견할 수 있습니다.',
      category: '관광',
    },
    {
      id: 4,
      ...
      title: '서쪽 노을 명소',
      content:
        '용눈이오름을 제외하고, 노을은 서쪽이 가장 아름답습니다. 해가 서쪽으로 지기 때문이겠죠?',
      category: '풍경',
    },
    {
      id: 5,
      ...
      title: '최고의 계절은 가을',
      content:
        '로컬들이 뽑는 가장 좋은 제주도의 계절은 가을입니다. 사람도 적당히 없고, 정말 예뻐요.',
      category: '계절',
    },
    {
      id: 6,
      ...
      title: '정성이 담긴 서비스',
      content:
        '제주도는 어딘가에서 상처받은 사람이 많이 모입니다. 그렇기에 정성을 담은 서비스가 많아요. 당신만의 특별한 공간을 찾아보세요.',
      category: '문화',
    },
  ];
  ...
  const creators = [
    {
      ...
      social: [
        {
          platform: 'instagram',
          url: 'https://www.instagram.com/van_gona_/',
          icon: faInstagramBrand,
        },
        {
          platform: 'facebook',
          url: 'https://www.facebook.com/gonavankim',
          icon: faFacebookBrand,
        },
        {
          platform: 'github',
          url: 'https://github.com/vangona/',
          icon: faGithubBrand,
        },
      ],
    },
    ...
    <div className='tips__page'>
      ...
      <main className='tips__content'>
        <div className='tips__container'>
          ...
          <div className='tips__intro'>
            ...
            <p>
              7개월간의 제주도 체험과 5년간의 거주 경험을 바탕으로 한 진짜
              팁들을 만나보세요.
            </p>
          </div>
      ...
      <footer className='tips__footer'>
        <span className='copyright'>
          &copy; {new Date().getFullYear()}, 나만의 서랍장 Co. all rights
          reserved.
        </span>
      </footer>
