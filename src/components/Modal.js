                ...
                <div className="map-detail__container modal-container"> 
                    <div className="map__detail vertical">
                        ...
                        {place.attachmentUrlArray[0] && (
                            <>
                                <img className="map-detail__img" src={place.attachmentUrlArray[0]} alt="detail-img" width="100%" height="auto"/>
                        ...
                        <div className="map-detail__description">{place.description.length > 100 ? place.description.slice(0, 100) + "..." : place.description}</div>
                        <div>
                        {place.url !== "" && <a href={place.url} target="_blank" rel="noreferrer"><button className="map-detail__url map-detail__btn">관련 사이트</button></a>}
                        <Link to={{
                        ...
                        <div className="map__detail-clear" onClick={onBackgroundClick}>❌</div>
                    </div>
                </div>
        </div>
    )
